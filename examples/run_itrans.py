...
if is_train:
    ...
    file_name = f"model/param/itransformer_{current_time}_epoch{num_epochs}.pth"
    torch.save(model.state_dict(), file_name)
    print("The model has been saved successfully!")
else:
    model.load_state_dict(torch.load('model/param/itransformer_20241029_181148_epoch800.pth'))
