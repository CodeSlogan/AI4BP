...
from model.timellm.TimeLLM import Model
...
from model.timellm.utils.tools import del_files, EarlyStopping, adjust_learning_rate, vali, load_content
...
parser.add_argument('--checkpoints', type=str, default='./model/param', help='location of model checkpoints')
...
for ii in range(args.itr):
    ...
    for epoch in range(args.train_epochs):
        ...
        vali_loss, vali_mae_loss = vali(args, accelerator, model, vali_loader, criterion, mae_metric)
        test_loss, test_mae_loss = vali(args, accelerator, model, test_loader, criterion, mae_metric)
        accelerator.print(
